...
{ short state;			/* 0 = uninitialized, 1 = initialized, 2 = copy of another soap struct */
  ...
  const char *certfile;       // has been added for gridsam support
  const char *keyfile;
  const char *password;
  const char *dhfile;
  const char *cafile;
...
SOAP_FMAC1 int SOAP_FMAC2 soap_ssl_client_context_cert(struct soap*, unsigned short, const char*, const char*, const char*, const char*, const char*, const char*);
