...
class endpoint_smoa_2 : public endpoint
{
  public:
    ...
    {
      type     = "UserPass";
      url      = "https://grass1.man.poznan.pl:19003";
   // url      = "https://localhost:10005";
      user     = "";
      pass     = "";
      cert     = "/home/saga/saga_bes_job/ogf_job_hpcbp/test/hostcertkey.pem";
      key      = "/home/saga/saga_bes_job/ogf_job_hpcbp/test/hostcertkey.pem";
