...
#ifdef  ADAPTORS_NAREGI_JOB_OSTREAM_HPP
#define ADAPTORS_NAREGI_JOB_OSTREAM_HPP
...
namespace naregi_job
{
  ...
  {
    private:
      typedef impl::naregi_job_stream <saga::adaptors::ostream_ptr>
              impl_type;
...
#endif // ADAPTORS_NAREGI_JOB_OSTREAM_HPP
