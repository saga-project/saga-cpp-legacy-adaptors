...
#if !defined(ADAPTORS_NAREGI_JOB_ISTREAM_HPP)
#define ADAPTORS_NAREGI_JOB_ISTREAM_HPP
...
namespace naregi_job
{
  ...
  {
    private:
      typedef impl::naregi_job::stream <saga::adaptors::istream_ptr>
              impl_type;
...
#endif // !defined(ADAPTORS_NAREGI_JOB_ISTREAM_HPP)
