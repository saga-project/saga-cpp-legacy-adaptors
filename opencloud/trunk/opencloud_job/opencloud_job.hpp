...
#ifndef ADAPTORS_OPENCLOUD_JOB_HPP
#define ADAPTORS_OPENCLOUD_JOB_HPP
...
// adaptor includes
#include "opencloud_job_adaptor.hpp"
...
namespace opencloud_job
{
    ...
    : public saga::adaptors::v1_0::job_cpi <job_cpi_impl>
  {
    private:
      ...
      int scan_and_find( std::string const &file_dir, std::vector<std::string> &fileset ) ; 
...
#endif // ADAPTORS_OPENCLOUD_JOB_HPP
