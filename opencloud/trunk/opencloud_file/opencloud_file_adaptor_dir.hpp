...
#ifndef ADAPTORS_OPENCLOUD_FILE_ADAPTOR_DIR_HPP
#define ADAPTORS_OPENCLOUD_FILE_ADAPTOR_DIR_HPP
...
namespace opencloud_file_adaptor 
{
  ...
  class dir_cpi_impl : public saga::adaptors::v1_0::directory_cpi<dir_cpi_impl>
  {
    private:
      ...
      void sync_init (void);
      void set_dir_name () ; 
      bool open_dir( std::string &error ) ; 
      bool resolve( saga::url const &url_, std::string & ret ) ; 
      ...
      /* The directory parsed from the URL */
      std::string dir_ ; 
      ...
      saga_sector::dir_service & dserv_ ; 
...
#endif // ADAPTORS_OPENCLOUD_FILE_ADAPTOR_DIR_HPP
