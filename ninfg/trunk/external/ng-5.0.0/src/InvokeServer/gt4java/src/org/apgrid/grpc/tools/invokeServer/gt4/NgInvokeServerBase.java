/*
 * $RCSfile: NgInvokeServerBase.java,v $ $Revision: 1.4 $ $Date: 2007/09/26 04:14:05 $
 * $AIST_Release: 5.0.0 $
 * $AIST_Copyright:
...
abstract class NgInvokeServerBase implements Runnable {
	...
	public static final String REQUEST_QUERY_FEATURES = "QUERY_FEATURES";
	...
	public static final String INVOKE_SERVER_PROT_DELIMITER = "\r\n";
	...
	public void run() {
		...
		try {
			...
			while ((line = this.br.readLine()) != null) {
				...
				if (line.startsWith(REQUEST_QUERY_FEATURES)) {
				    continue;
				}
