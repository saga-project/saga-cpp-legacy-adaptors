/*
 * $RCSfile: ngisUtility.c,v $ $Revision: 1.6 $ $Date: 2008/02/26 06:32:39 $
 * $AIST_Release: 5.0.0 $
 * $AIST_Copyright:
...
NGI_RCSID_EMBED("$RCSfile: ngisUtility.c,v $ $Revision: 1.6 $ $Date: 2008/02/26 06:32:39 $")
...
ngisiCondBroadcast(
    ...
    int *error)
{
    static const char fName[] = "ngisiCondBroadcast";
    int result;
