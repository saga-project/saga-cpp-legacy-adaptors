/*
 * $RCSfile: InvokeServer.java,v $ $Revision: 1.6 $ $Date: 2008/02/07 08:17:42 $
 * $AIST_Release: 5.0.0 $
 * $AIST_Copyright:
...
public class InvokeServer{
    ...
    private static final String CMD_QUERY_FEATURES = "QUERY_FEATURES";
	...
	if (id.equals(CMD_QUERY_FEATURES))
	    return new QueryFeaturesCommand(this);
