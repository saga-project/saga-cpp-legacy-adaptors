/*
 * $RCSfile: NaregiSSJobFactory.java,v $ $Revision: 1.3 $ $Date: 2007/09/26 04:14:05 $
 * $AIST_Release: 5.0.0 $
 * $AIST_Copyright:
...
public class NaregiSSJobFactory implements TargetJobFactory {
	...
	public TargetFeature createFeature(QueryFeaturesCommand command) throws Command.Exception{
		return new NaregiSSFeature(command);
	}
