/*
 * $RCSfile: ngInvokeServerSSH.h,v $ $Revision: 1.4 $ $Date: 2008/03/28 03:52:30 $
 * $AIST_Release: 5.0.0 $
 * $AIST_Copyright:
...
#define ngsja_authNumber             ngsja_attributes->ngja_authNumber
#define ngsja_commProxyStaging       ngsja_attributes->ngja_commProxyStaging
#define ngsja_commProxyPath          ngsja_attributes->ngja_commProxyPath
...
struct ngisSSHjob_s {
    ...
    char                           *ngsj_remoteAuthNumberPath;
