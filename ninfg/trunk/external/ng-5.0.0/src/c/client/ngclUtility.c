/*
 * $RCSfile: ngclUtility.c,v $ $Revision: 1.5 $ $Date: 2007/09/26 04:14:06 $
 * $AIST_Release: 5.0.0 $
 * $AIST_Copyright:
...
NGI_RCSID_EMBED("$RCSfile: ngclUtility.c,v $ $Revision: 1.5 $ $Date: 2007/09/26 04:14:06 $")

/**
 * Prototype declaration of static functions.
 */
static int ngcllRWlockInitialize(ngclContext_t *, ngiRWlock_t *, int *);
static int ngcllRWlockFinalize(ngclContext_t *, ngiRWlock_t *, int *);
static int ngcllRWlockReadLock(ngclContext_t *, ngiRWlock_t *, int *);
static int ngcllRWlockReadUnlock(ngclContext_t *, ngiRWlock_t *, int *);
static int ngcllRWlockWriteLock(ngclContext_t *, ngiRWlock_t *, int *);
static int ngcllRWlockWriteUnlock(ngclContext_t *, ngiRWlock_t *, int *);

/**
 * Read/Write Lock: Initialize
 */
int
ngclRWlockInitialize(ngclContext_t *context, ngiRWlock_t *rwLock, int *error)
{
...
static int
ngcllRWlockInitialize(ngclContext_t *context, ngiRWlock_t *rwLock, int *error)
{
    int result;
 ...
 */
int
ngclRWlockFinalize(ngclContext_t *context, ngiRWlock_t *rwLock, int *error)
{
    int local_error, result;
...
static int
ngcllRWlockFinalize(ngclContext_t *context, ngiRWlock_t *rwLock, int *error)
{
    int result;
 ...
 */
int
ngclRWlockReadLock(ngclContext_t *context, ngiRWlock_t *rwLock, int *error)
{
    int local_error, result;
...
static int
ngcllRWlockReadLock(ngclContext_t *context, ngiRWlock_t *rwLock, int *error)
{
    int result;
 ...
 */
int
ngclRWlockReadUnlock(ngclContext_t *context, ngiRWlock_t *rwLock, int *error)
{
    int local_error, result;
...
static int
ngcllRWlockReadUnlock(ngclContext_t *context, ngiRWlock_t *rwLock, int *error)
{
    int result;
 ...
 */
int
ngclRWlockWriteLock(ngclContext_t *context, ngiRWlock_t *rwLock, int *error)
{
    int local_error, result;
...
static int
ngcllRWlockWriteLock(ngclContext_t *context, ngiRWlock_t *rwLock, int *error)
{
    int result;
 ...
 */
int
ngclRWlockWriteUnlock(ngclContext_t *context, ngiRWlock_t *rwLock, int *error)
{
    int local_error, result;
...
static int
ngcllRWlockWriteUnlock(ngclContext_t *context, ngiRWlock_t *rwLock, int *error)
{
    int result;
