/*
 * $RCSfile: FileTest.java,v $ $Revision: 1.2 $ $Date: 2007/09/26 04:14:07 $
 * $AIST_Release: 5.0.0 $
 * $AIST_Copyright:
 ...
 * - transfer BINARY file, and output file already exists
 * - transfer BINARY file, and output file doesn't exists
 * - transfer TEXT file, and output file already exists
 * - transfer TEXT file, and output file doesn't exists
 */
public class FileTest {
	...
	static void checkArguments(String [] args) {
		if (args.length < 1) {
			throw new IllegalArgumentException("must specify name of configfile.");
		} else if ( new File(args[0]).exists() != true) {
			throw new IllegalArgumentException("specified configfile( " 
