/*
 * $RCSfile: SkipTest.java,v $ $Revision: 1.2 $ $Date: 2007/09/26 04:14:07 $
 * $AIST_Release: 5.0.0 $
 * $AIST_Copyright:
...
public class SkipTest {
	...
	public static void main (String[] args) {
		...
		try {
			...
			printResult( skipTest.skipCharTest() );
			
			// short test 
			System.out.print ("Skip Short Test : ");
			printResult( skipTest.skipShortTest() );
			
			// int test 
			System.out.print ("Skip Int Test : ");
			printResult( skipTest.skipIntTest() );
			
			// long test 
			System.out.print ("Skip Long Test : ");
			printResult( skipTest.skipLongTest() ); 

			// float test 
			System.out.print ("Skip Float Test : ");
			printResult( skipTest.skipFloatTest() ); 

			// double test 
			System.out.print ("Skip Double Test : ");
			printResult( skipTest.skipDoubleTest() );

			// scomplex test 
			System.out.print ("Skip Scomplex Test : ");
			printResult( skipTest.skipScomplexTest() );
			
			// dcomplex test 
			System.out.print ("Skip Dcomplex Test : ");
			printResult( skipTest.skipDcomplexTest() );

			// inout test 
			System.out.print ("Skip inout Test : ");
			printResult( skipTest.skipInOutTest() );
			
			// skip one test 
			System.out.print ("Skip one Test : ");
			printResult(skipTest.skipOneTest() );
			
			// skip 2D test 
			System.out.print ("Skip 2D Test : ");
			printResult( skipTest.skip2DTest() );

			// skip 3D test 
			System.out.print ("Skip 3D Test : ");
			printResult( skipTest.skip3DTest() ); 
			
			// omit skip test 
			System.out.print ("Skip Omit Skip Test : ");
			printResult( skipTest.skipOmitSkipTest() );
			
			// omit end test 
			System.out.print ("Skip Omit End Test : ");
			printResult( skipTest.skipOmitEndTest() );
			...
			printResult( skipTest.skipCallbackTest() );
