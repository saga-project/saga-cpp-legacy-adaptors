/*
 * $RCSfile: ProtInvokeSessionReply.java,v $ $Revision: 1.8 $ $Date: 2007/09/26 04:14:08 $
 * $AIST_Release: 5.0.0 $
 * $AIST_Copyright:
...
public final class ProtInvokeSessionReply
extends AbstractReceivableProtocol
implements Protocol {

	private final static String NAME = "InvokeSessionReply";
