/*
 * $RCSfile: ProtCancelSessionRequest.java,v $ $Revision: 1.8 $ $Date: 2008/02/07 08:17:43 $
 * $AIST_Release: 5.0.0 $
 * $AIST_Copyright:
...
public final class ProtCancelSessionRequest
extends NoParamRequestSkeleton
implements NgProtocolRequest {

	private static final String NAME = "CancelSessionRequest";
	private static final int KIND = 0;
	private static final int TYPE = 0x24;
