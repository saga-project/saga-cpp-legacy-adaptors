/*
 * $RCSfile: ProtResumeSessionRequest.java,v $ $Revision: 1.8 $ $Date: 2008/02/07 08:17:43 $
 * $AIST_Release: 5.0.0 $
 * $AIST_Copyright:
...
public final class ProtResumeSessionRequest
extends NoParamRequestSkeleton
implements NgProtocolRequest {

	private final static String NAME = "ResumeSessionRequest";
	private final static int KIND = 0;
	private final static int TYPE = 0x23;
