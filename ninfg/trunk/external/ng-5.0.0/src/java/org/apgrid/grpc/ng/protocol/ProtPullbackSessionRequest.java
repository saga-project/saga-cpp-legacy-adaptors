/*
 * $RCSfile: ProtPullbackSessionRequest.java,v $ $Revision: 1.8 $ $Date: 2008/02/07 08:17:43 $
 * $AIST_Release: 5.0.0 $
 * $AIST_Copyright:
...
public final class ProtPullbackSessionRequest
extends NoParamRequestSkeleton
implements NgProtocolRequest {

	private final static String NAME = "PullBackSessionRequest";
