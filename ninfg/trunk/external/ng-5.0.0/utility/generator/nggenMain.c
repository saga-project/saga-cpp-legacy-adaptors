/*
 * $RCSfile: nggenMain.c,v $ $Revision: 1.6 $ $Date: 2008/03/12 09:18:18 $
 * $AIST_Release: 5.0.0 $
 * $AIST_Copyright:
...
NGI_RCSID_EMBED("$RCSfile: nggenMain.c,v $ $Revision: 1.6 $ $Date: 2008/03/12 09:18:18 $")
...
)
{
    ...
    --argc;
    ++argv;
    snprintf(cpp_command, NG_BUFSIZ, "%s", NGI_IDL_CPP);
    /*====================================
      input arg check
      ====================================*/
...
#ifdef NGI_NO_IDL_CPP_ACCEPT_IDL_FILE
    cpp_idl_rename = 1;
#endif /* NGI_NO_IDL_CPP_ACCEPT_IDL_FILE */
