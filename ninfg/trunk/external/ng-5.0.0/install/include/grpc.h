/*
 * $RCSfile: grpc.h,v $ $Revision: 1.4 $ $Date: 2008/02/07 10:26:15 $
 * $AIST_Release: 5.0.0 $
 * $AIST_Copyright:
...
typedef struct grpc_session_attr_s_np {
    ...
    int                          gsa_timeout;
    int                          gsa_transferTimeout_argument;
    int                          gsa_transferTimeout_result;
    int                          gsa_transferTimeout_cbArgument;
    int                          gsa_transferTimeout_cbResult;
...
typedef enum grpc_session_attr_name_e_np {
    ...
    GRPC_SESSION_ATTR_TRANSFER_TIMEOUT_ARGUMENT,
    GRPC_SESSION_ATTR_TRANSFER_TIMEOUT_RESULT,
    GRPC_SESSION_ATTR_TRANSFER_TIMEOUT_CALLBACK_ARGUMENT,
    GRPC_SESSION_ATTR_TRANSFER_TIMEOUT_CALLBACK_RESULT
...
/**
 * Information for Argument stacks
 */
...
/* Session Information management API */
