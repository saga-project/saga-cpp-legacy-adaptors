#ifndef NG_OS_IRIX
static const char rcsid[] = "$RCSfile: ngisRefreshCredential.c,v $ $Revision: 1.3 $ $Date: 2006/08/22 05:52:10 $";
#endif /* NG_OS_IRIX */
/*
 * $AIST_Release: 4.2.4 $
 * $AIST_Copyright:
    ...
    int *error)
{
    ...
    /**
     * Suppress unlock and lock, to ignore CondSignal(!working) issue,
