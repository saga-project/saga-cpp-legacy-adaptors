#ifndef NG_OS_IRIX
static const char rcsid[] = "$RCSfile: ngisRequest.c,v $ $Revision: 1.8 $ $Date: 2007/09/11 09:21:00 $";
#endif /* NG_OS_IRIX */
/* 
 * $AIST_Release: 4.2.4 $
 * $AIST_Copyright:
    ...
    void *threadArgument)
{
    ...
    assert(requestReader->ngisr_stopped == 0);
