/*
 * $RCSfile: ngisUtility.h,v $ $Revision: 1.4 $ $Date: 2006/12/08 08:34:32 $
 * $AIST_Release: 4.2.4 $
 * $AIST_Copyright:
...
/* MACROS */
#ifdef NGIS_AVAILABLE_ATTRIBUTE_PRINTF
#define NGIS_ATTRIBUTE_PRINTF(p1, p2) \
...
/* For string */
char *ngisStrdupPrintf(const char *, ...) NGIS_ATTRIBUTE_PRINTF(1, 2);
