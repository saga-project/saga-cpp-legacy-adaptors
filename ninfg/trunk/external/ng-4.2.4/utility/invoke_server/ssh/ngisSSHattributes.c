...
static char * MPIoptionStringToFormat(char *option, char special);
    ...
    ngisOptionContainer_t *opts)
{
    ...
    mpiNPoption = MPIoptionStringToFormat(
    ...
    mpiMachineFileOption = MPIoptionStringToFormat(
...
static char *
MPIoptionStringToFormat(char *option, char special)
{
    char *buffer = NULL;
    char *src;
    char *dest;
    int  specialAppeared = 0;
    static const char fName[] = "MPIoptionStringToFormat";
    ...
    while (*src != '\0') {
        ...
        case '\n':
        case '\r':
            ngisErrorPrint(NULL, fName, "Invalid charactor.\n");
            goto error;
            break;
        default:
            break;
