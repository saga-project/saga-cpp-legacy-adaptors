/*
 * $RCSfile: grpcLocal.h,v $ $Revision: 1.37 $ $Date: 2007/07/10 05:19:42 $
 * $AIST_Release: 4.2.4 $
 * $AIST_Copyright:
...
typedef struct grpc_l_session_queue_s {
    ...
    ngRWlock_t     gsq_lock;        /* for lock of this instance */
...
typedef struct grpc_l_error_s {
    ...
    ngRWlock_t   ge_lock;    /* for lock of this instance */
} grpc_l_error_t;
...
grpc_error_t grpc_l_server_name_decode(
    ngclExecutableAttribute_t *, char *);
