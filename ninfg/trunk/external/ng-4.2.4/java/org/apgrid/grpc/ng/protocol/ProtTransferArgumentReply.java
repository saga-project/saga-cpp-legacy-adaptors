 ...
 *  $
 * $RCSfile: ProtTransferArgumentReply.java,v $ $Revision: 1.17 $ $Date: 2005/06/13 05:48:06 $
 */
...
public class ProtTransferArgumentReply extends Protocol {
	public final static String PROTO_STR = "ProtTransferArgumentReply";
	 ...
	 * @param sessionID
	 */
	public ProtTransferArgumentReply(int sequenceNum,
	 ...
	 * @throws GrpcException
	 */
	public ProtTransferArgumentReply(Node node)
		throws GrpcException {
		super(node);
		setTypeAndKind();
	}
