 ...
 *  $
 * $RCSfile: ProtExitExeReply.java,v $ $Revision: 1.16 $ $Date: 2005/06/13 05:48:06 $
 */
...
public class ProtExitExeReply extends Protocol {
	public static final String PROTO_STR = "ProtExitExeReply";
	 ...
	 * @param result
	 */
	public ProtExitExeReply(int sequenceNum,
	 ...
	 */
	public ProtExitExeReply(NgDataInputStream ngdi)
		throws GrpcException {
		super(ngdi);
		setTypeAndKind();
	}
	 ...
	 * @throws GrpcException
	 */
	public ProtExitExeReply(Node node) throws GrpcException {
		super(node);
		setTypeAndKind();		
	}
