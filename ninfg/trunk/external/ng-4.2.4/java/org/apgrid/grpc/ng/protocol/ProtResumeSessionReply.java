 ...
 *  $
 * $RCSfile: ProtResumeSessionReply.java,v $ $Revision: 1.17 $ $Date: 2005/06/13 05:48:06 $
 */
...
public class ProtResumeSessionReply extends Protocol {
	public final static String PROTO_STR = "ProtResumeSessionReply";
	 ...
	 * @param result
	 */
	public ProtResumeSessionReply(int sequenceNum,
	 ...
	 */
	public ProtResumeSessionReply(NgDataInputStream ngdi)
		throws GrpcException {
		super(ngdi);

		/* set type & kind for ResumeSessionReply */
		this.kind = 1;
		this.type = 0x22;
	}
	 ...
	 * @throws GrpcException
	 */
	public ProtResumeSessionReply(Node node)
		throws GrpcException {
		super(node);
		setTypeAndKind();
	}
