 ...
 *  $
 * $RCSfile: ProtSuspendSessionReply.java,v $ $Revision: 1.17 $ $Date: 2005/06/13 05:48:06 $
 */
...
public class ProtSuspendSessionReply extends Protocol {
	public final static String PROTO_STR = "ProtSuspendSessionReply";
	 ...
	 * @param sessionID
	 */
	public ProtSuspendSessionReply(int sequenceNum,
	 ...
	 */
	public ProtSuspendSessionReply(NgDataInputStream ngdi)
		throws GrpcException {
		super(ngdi);
		setTypeAndKind();
	}
	 ...
	 * @throws GrpcException
	 */
	public ProtSuspendSessionReply(Node node)
		throws GrpcException {
		super(node);
		setTypeAndKind();
	}
