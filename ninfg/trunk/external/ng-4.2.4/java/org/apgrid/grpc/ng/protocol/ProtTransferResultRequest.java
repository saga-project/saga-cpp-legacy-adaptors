 ...
 *  $
 * $RCSfile: ProtTransferResultRequest.java,v $ $Revision: 1.19 $ $Date: 2005/06/13 05:48:06 $
 */
...
public class ProtTransferResultRequest extends Protocol {
	public final static String PROTO_STR = "ProtTransferResultRequest";
	 ...
	 */
	public ProtTransferResultRequest(NgDataInputStream ngdi)
		throws GrpcException {
		super(ngdi);
		setTypeAndKind();
	}
	 ...
	 * @throws GrpcException
	 */
	public ProtTransferResultRequest(Node node)
		throws GrpcException {
		super(node);
		setTypeAndKind();
	}
