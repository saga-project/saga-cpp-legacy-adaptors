 ...
 *  $
 * $RCSfile: ProtQueryFunctionInfoRequest.java,v $ $Revision: 1.16 $ $Date: 2005/06/13 05:48:06 $
 */
...
public class ProtQueryFunctionInfoRequest extends Protocol {
	public final static String PROTO_STR = "ProtQueryFunctionInfoRequest";
	 ...
	 * @param sessionID
	 */
	public ProtQueryFunctionInfoRequest(int sequenceNum,
		...
		super(PROTOCOL_KIND,		/* Request */
			PROTOCOL_TYPE,	/* QueryFunctionInfo */
			sequenceNum,
			contextID,
			executableID,
			sessionID,
	 ...
	 */
	public ProtQueryFunctionInfoRequest(
		NgDataInputStream ngdi)	throws GrpcException {
		super(ngdi);
		setTypeAndKind();
	}
	 ...
	 * @throws GrpcException
	 */
	public ProtQueryFunctionInfoRequest(Node node)
		throws GrpcException {
		super(node);
		setTypeAndKind();
	}
