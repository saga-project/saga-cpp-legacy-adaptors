 ...
 *  $
 * $RCSfile: NgGrpcFunctionHandle.java,v $ $Revision: 1.19 $ $Date: 2006/08/22 10:54:32 $
 */
 ...
 */
public class NgGrpcFunctionHandle extends GrpcFunctionHandle implements Cloneable {
	 ...
	 */
	protected NgGrpcFunctionHandle(String className,
	 ...
	 */
	protected NgGrpcFunctionHandle(String className,
		Properties prop, NgGrpcClient context, int jobID,
		int executableID, int jobCount) throws GrpcException {
		handle = new NgGrpcHandle (className,
