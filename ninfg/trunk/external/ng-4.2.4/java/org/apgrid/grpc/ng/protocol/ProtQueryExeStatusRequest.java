 ...
 *  $
 * $RCSfile: ProtQueryExeStatusRequest.java,v $ $Revision: 1.16 $ $Date: 2005/06/13 05:48:06 $
 */
...
public class ProtQueryExeStatusRequest extends Protocol {
	public final static String PROTO_STR = "ProtQueryExeStatusRequest";
	 ...
	 */
	public ProtQueryExeStatusRequest(NgDataInputStream ngdi)
		throws GrpcException {
		super(ngdi);
		setTypeAndKind();
	}
	 ...
	 * @throws GrpcException
	 */
	public ProtQueryExeStatusRequest(Node node)
		throws GrpcException {
		super(node);
		setTypeAndKind();
	}
