 ...
 *  $
 * $RCSfile: ProtExitExeRequest.java,v $ $Revision: 1.16 $ $Date: 2005/06/13 05:48:06 $
 */
...
public class ProtExitExeRequest extends Protocol {
	public static final String PROTO_STR = "ProtExitExeRequest";
	public static final int PROTOCOL_KIND = 0;
	public static final int PROTOCOL_TYPE = 0x12;
	public static final String PROTOCOL_TYPE_XML_STR = "exitExecutable";
	 ...
	 * @throws GrpcException
	 */
	public ProtExitExeRequest(NgDataInputStream ngdi)
			throws GrpcException {
		super(ngdi);
		setTypeAndKind();
	}
	 ...
	 * @throws GrpcException
	 */
	public ProtExitExeRequest(Node node) throws GrpcException {
		super(node);
		setTypeAndKind();
	}
