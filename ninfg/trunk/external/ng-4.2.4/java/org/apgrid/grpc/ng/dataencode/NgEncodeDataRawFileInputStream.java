 ...
 *  $
 * $RCSfile: NgEncodeDataRawFileInputStream.java,v $ $Revision: 1.10 $ $Date: 2006/10/11 08:13:49 $
 */
...
public class NgEncodeDataRawFileInputStream extends NgEncodeDataFileTypeInputStream {
	 ...
	 * @throws IOException
	 */
	public NgEncodeDataRawFileInputStream(String arg0, int mode) throws IOException {
		super(arg0, mode);
	 ...
	 * @throws IOException
	 */
	public NgEncodeDataRawFileInputStream(String arg0, int length, int mode) throws IOException {
		super(arg0, mode);
