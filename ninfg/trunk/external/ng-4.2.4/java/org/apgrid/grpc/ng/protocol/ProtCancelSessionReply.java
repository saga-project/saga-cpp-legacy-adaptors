 ...
 *  $
 * $RCSfile: ProtCancelSessionReply.java,v $ $Revision: 1.17 $ $Date: 2005/06/13 05:48:06 $
 */
...
public class ProtCancelSessionReply extends Protocol {
	public static final String PROTO_STR = "ProtCancelSessionReply";
	public static final int PROTOCOL_KIND = 1;
	 ...
	 * @param result
	 */
	public ProtCancelSessionReply(int sequenceNum,
	 ...
	 */
	public ProtCancelSessionReply(NgDataInputStream ngdi)
		throws GrpcException {
		super(ngdi);
		setTypeAndKind();
	}
	 ...
	 * @throws GrpcException
	 */
	public ProtCancelSessionReply(Node node) 
		throws GrpcException {
		super(node);
		setTypeAndKind();
	}
