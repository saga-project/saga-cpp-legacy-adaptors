 ...
 *  $
 * $RCSfile: ProtInvokeSessionReply.java,v $ $Revision: 1.17 $ $Date: 2005/06/13 05:48:06 $
 */
...
public class ProtInvokeSessionReply extends Protocol {
	public final static String PROTO_STR = "ProtInvokeSessionReply";
	 ...
	 * @param result
	 */
	public ProtInvokeSessionReply(int sequenceNum,
	 ...
	 */
	public ProtInvokeSessionReply(NgDataInputStream ngdi)
		throws GrpcException {
		super(ngdi);
		setTypeAndKind();
	}
	 ...
	 * @throws GrpcException
	 */
	public ProtInvokeSessionReply(Node node)
		throws GrpcException {
		super(node);
		setTypeAndKind();
	}
