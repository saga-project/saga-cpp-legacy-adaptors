 ...
 *  $
 * $RCSfile: ProtSuspendSessionRequest.java,v $ $Revision: 1.17 $ $Date: 2005/06/13 05:48:06 $
 */
...
public class ProtSuspendSessionRequest extends Protocol {
	public final static String PROTO_STR = "ProtSuspendSessionRequest";
	public final static int PROTOCOL_KIND = 0;
	public final static int PROTOCOL_TYPE = 0x22;
	public final static String PROTOCOL_TYPE_XML_STR = "suspendSession";
	 ...
	 * @param sessionID
	 */
	public ProtSuspendSessionRequest(int sequenceNum,
	 ...
	 */
	public ProtSuspendSessionRequest(NgDataInputStream ngdi)
			throws GrpcException {
		super(ngdi);
		setTypeAndKind();
	}
	 ...
	 * @throws GrpcException
	 */
	public ProtSuspendSessionRequest(Node node)
		throws GrpcException {
		super(node);
		setTypeAndKind();
	}
