 ...
 *  $
 * $RCSfile: ProtCancelSessionRequest.java,v $ $Revision: 1.18 $ $Date: 2005/06/13 05:48:06 $
 */
...
public class ProtCancelSessionRequest extends Protocol {
	public static final String PROTO_STR = "ProtCancelSessionRequest";
	public static final int PROTOCOL_KIND = 0;
	public static final int PROTOCOL_TYPE = 0x24;
	public static final String PROTOCOL_TYPE_XML_STR = "cancelSession";
	 ...
	 * @param sessionID
	 */
	public ProtCancelSessionRequest(int sequenceNum,
	 ...
	 */
	public ProtCancelSessionRequest(NgDataInputStream ngdi)
		throws GrpcException {
		super(ngdi);
		setTypeAndKind();
	}
	 ...
	 * @throws GrpcException
	 */
	public ProtCancelSessionRequest(Node node)
		throws GrpcException {
		super(node);
		setTypeAndKind();
	}
