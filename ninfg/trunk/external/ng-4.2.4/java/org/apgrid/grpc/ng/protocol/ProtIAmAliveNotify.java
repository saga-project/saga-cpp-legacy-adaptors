 ...
 *  $
 * $RCSfile: ProtIAmAliveNotify.java,v $ $Revision: 1.17 $ $Date: 2005/06/13 05:48:06 $
 */
...
public class ProtIAmAliveNotify extends Protocol {
	public static final String PROTO_STR = "ProtIAmAliveNotify";
	public static final int PROTOCOL_KIND = 2;
	public static final int PROTOCOL_TYPE = 0x01;
	public static final String PROTOCOL_TYPE_XML_STR = "iAmAlive";
	 ...
	 * @param sessionID
	 */
	public ProtIAmAliveNotify(int sequenceNum,
	 ...
	 */
	public ProtIAmAliveNotify(NgDataInputStream ngdi)
		throws GrpcException {
		super(ngdi);
		setTypeAndKind();
	}
	 ...
	 * @throws GrpcException
	 */
	public ProtIAmAliveNotify(Node node) throws GrpcException {
		super(node);
		setTypeAndKind();
	}
