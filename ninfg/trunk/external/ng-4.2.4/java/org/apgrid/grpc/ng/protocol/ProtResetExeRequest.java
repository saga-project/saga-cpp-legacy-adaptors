 ...
 *  $
 * $RCSfile: ProtResetExeRequest.java,v $ $Revision: 1.17 $ $Date: 2005/06/13 05:48:06 $
 */
...
public class ProtResetExeRequest extends Protocol {
	public final static String PROTO_STR = "ProtResetExeRequest";
	 ...
	 * @param sessionID
	 */
	public ProtResetExeRequest(int sequenceNum,
	 ...
	 */
	public ProtResetExeRequest(NgDataInputStream ngdi)
		throws GrpcException {
		super(ngdi);
		setTypeAndKind();
	}
	 ...
	 * @throws GrpcException
	 */
	public ProtResetExeRequest(Node node)
		throws GrpcException {
		super(node);
		setTypeAndKind();
	}
