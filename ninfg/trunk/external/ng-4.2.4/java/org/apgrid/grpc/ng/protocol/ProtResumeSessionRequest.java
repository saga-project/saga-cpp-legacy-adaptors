 ...
 *  $
 * $RCSfile: ProtResumeSessionRequest.java,v $ $Revision: 1.18 $ $Date: 2005/06/13 05:48:06 $
 */
...
public class ProtResumeSessionRequest extends Protocol {
	public final static String PROTO_STR = "ProtResumeSessionRequest";
	public final static int PROTOCOL_KIND = 0;
	public final static int PROTOCOL_TYPE = 0x23;
	public final static String PROTOCOL_TYPE_XML_STR = "resumeSession";
	 ...
	 * @param sessionID
	 */
	public ProtResumeSessionRequest(int sequenceNum,
	 ...
	 */
	public ProtResumeSessionRequest(NgDataInputStream ngdi)
		throws GrpcException {
		super(ngdi);
		setTypeAndKind();
	}
	 ...
	 * @throws GrpcException
	 */
	public ProtResumeSessionRequest(Node node)
		throws GrpcException {
		super(node);
		setTypeAndKind();
	}
