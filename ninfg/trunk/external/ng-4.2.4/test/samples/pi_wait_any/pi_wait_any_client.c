#ifndef NG_OS_IRIX
static const char rcsid[] = "$RCSfile: pi_wait_any_client.c,v $ $Revision: 1.4 $ $Date: 2006/02/17 08:19:27 $";
#endif /* NG_OS_IRIX */
/*
 * $AIST_Release: 4.2.4 $
 * $AIST_Copyright:
...
main(int argc, char *argv[])
{
    ...
    if (result == 0) {
        fprintf(stderr, "USAGE: %s TIMES RPC_TIMES HOSTNAME1 HOSTANME2...\n",
            argv[0]);
        exit(2);
    }
