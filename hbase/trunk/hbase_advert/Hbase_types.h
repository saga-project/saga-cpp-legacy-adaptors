...
class ColumnDescriptor {
 public:
  ...
  static const char* ascii_fingerprint; // = "47E0712248475500EE800F155B43AEA4";
  static const uint8_t binary_fingerprint[16]; // = {0x47,0xE0,0x71,0x22,0x48,0x47,0x55,0x00,0xEE,0x80,0x0F,0x15,0x5B,0x43,0xAE,0xA4};

  ColumnDescriptor() : name(""), maxVersions(3), compression("NONE"), inMemory(false), maxValueLength(2147483647), bloomFilterType("NONE"), bloomFilterVectorSize(0), bloomFilterNbHashes(0), blockCacheEnabled(false), timeToLive(-1) {
  }
  ...
  struct __isset {
    __isset() : name(false), maxVersions(false), compression(false), inMemory(false), maxValueLength(false), bloomFilterType(false), bloomFilterVectorSize(false), bloomFilterNbHashes(false), blockCacheEnabled(false), timeToLive(false) {}
    bool name;
    bool maxVersions;
    bool compression;
    bool inMemory;
...
class IOError : public facebook::thrift::TException {
 public:
...
class IllegalArgument : public facebook::thrift::TException {
 public:
...
class NotFound : public facebook::thrift::TException {
 public:
  ...
  bool operator == (const NotFound & rhs) const
  {
    if (!(message == rhs.message))
      return false;
    return true;
  ...
  bool operator < (const NotFound & ) const;
...
class AlreadyExists : public facebook::thrift::TException {
 public:
