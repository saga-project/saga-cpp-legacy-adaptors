...
#ifndef SAGA_ADAPTORS_FAST_ADVERT_ADVERT_DATABASE_HPP
#define SAGA_ADAPTORS_FAST_ADVERT_ADVERT_DATABASE_HPP

#include <boost/assert.hpp>
#include <saga/saga/url.hpp>

#include "fast_advert_adaptor.hpp"
...
namespace fast_advert
{
    ...
    public:
        ...
        database_scope(Cpi *cpi_instance, database& db)
          : adaptor_ (TR1::static_pointer_cast<fast_advert::adaptor>(
    ...
    private:
        TR1::shared_ptr<fast_advert::adaptor> adaptor_;
        database& db_;
    };
