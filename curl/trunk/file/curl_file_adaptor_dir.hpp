...
#ifndef ADAPTORS_CURL_FILE_ADAPTOR_DIR_HPP
#define ADAPTORS_CURL_FILE_ADAPTOR_DIR_HPP

#include <saga/adaptors/adaptor.hpp>
#include <saga/adaptors/instance_data.hpp>
#include <saga/adaptors/adaptor_data.hpp>
#include <saga/adaptors/packages/filesystem.hpp>
...
public:
    ...
    void sync_remove		  (saga::impl::void_t & ret,
                           int flags = saga::filesystem::None);  
    void sync_close			  (saga::impl::void_t & ret, float timeout = 0.0); 
    ...
    void sync_get_size     (saga::off_t&, saga::url name, int flag); 
    ...
    void sync_open_dir		 (saga::filesystem::directory & entry, 
                            saga::url name_to_open, int openmode);
    void sync_is_file		   (bool & is_file, std::string name, int flags); 
    
    ///////////////////////////////////////////////////////////////////////////
    /////////////////////// PERMISSION INTERFACE METHODS //////////////////////
    ///////////////////////////////////////////////////////////////////////////
    
    /* synchronous permission interface */
...
#endif // ADAPTORS_CURL_FILE_ADAPTOR_DIR_HPP
