...
//			System.out.print(RNSUtil.toXMLStringFromEPR(epr));
	...
	public static String[] RNS_locations(String[] args) {
		RNSClientHome home = new RNSClientHome();
		home.setCustomUsage("RNS_path");
		boolean usage = true;
...
//			System.out.print(RNSUtil.toXMLStringFromEPR(epr));
			...
			locations.add(epr.getAddress().getValue().toString());
		...
		String[] result_locs = new String[locations.size()];
		locations.copyInto(result_locs);
