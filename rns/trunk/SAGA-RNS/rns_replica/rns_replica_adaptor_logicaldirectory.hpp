...
#ifndef __ADAPTORS_RNS_REPLICA_DIRECTORY_HPP
#define __ADAPTORS_RNS_REPLICA_DIRECTORY_HPP
...
#include "rns_replica_adaptor.hpp"
...
namespace rns_replica_adaptor
{
	...
	private:
        ...
        <rns_replica_adaptor::adaptor> adaptor_data_t;
        ...
        /// SRA customization//////////////////////////////////////////////////
        rns_replica_adaptor::api::rns_logicalfile rns_lfile;
        rns_replica_adaptor::api::rns_logicaldir  rns_ldir;
        bool is_opened;
        ...
        void check_state() {
          if (!is_opened) {
            SAGA_ADAPTOR_THROW ("the entry is not opened.", saga::IncorrectState);
          }
        }
...
//    	  rns_replica_adaptor::helper::check_scheme(url, false);
//      }
      set_path(url);
...
#endif	//__ADAPTORS_RNS_REPLICA_DIRECTORY_HPP
