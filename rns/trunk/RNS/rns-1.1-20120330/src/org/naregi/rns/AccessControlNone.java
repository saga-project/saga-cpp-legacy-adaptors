...
/**
 * An implementation for rns.server.accessControlType=none
 */
public class AccessControlNone implements AccessControl {
	private CallerInfo callerInfo = new NoneCallerInfo();

	private static class NoneCallerInfo implements CallerInfo {
