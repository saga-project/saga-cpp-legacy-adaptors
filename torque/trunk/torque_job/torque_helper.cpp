...
namespace torque_job { namespace helper {
  ...
  /////////////////////////////////////////////////////////////////////////////
  // convert SAGA JobID to PBS JobID
  //             [torque://hostname/]-[79] => 79
  // [torque://hostname/]-[79.server_host] => 79.server_host
  //
  ...
  /////////////////////////////////////////////////////////////////////////////
  // convert SAGA JobID to PBS JobID, short version
  //             [torque://hostname/]-[79] => 79
  // [torque://hostname/]-[79.server_host] => 79
  //
  std::string jobid_converter::convert_pbsid_short(const std::string& jobid)
  {
	  ...
	  tokenizer tokens(pbsid_long, sep);
	  tokenizer::iterator token_s = tokens.begin();
  ...
  /////////////////////////////////////////////////////////////////////////////
  // convert PBS JobID to JobID
  //             79 => [torque://hostname/]-[79]
  // 79.server_host => [torque://hostname/]-[79.server_host]
  //
